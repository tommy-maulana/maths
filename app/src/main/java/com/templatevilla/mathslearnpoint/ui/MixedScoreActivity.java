...
import com.templatevilla.mathslearnpoint.model.ProgressModel;
import com.templatevilla.mathslearnpoint.utils.ConnectionDetector;
...
public class MixedScoreActivity extends BaseActivity {
    ...
    public void showDialogs() {
        ...
        if (Constant.getCoins(getApplicationContext()) < 20) {
            ...
            text_coint.setText(getString(R.string.view_answer_coin)+"("+(Constant.getCoins(getApplicationContext()))+")");
    ...
    public void showGetCoinsDialogs() {
        ...
        LinearLayout bg_layout = view.findViewById(R.id.bg_layout);
        final AlertDialog dialog = builder.create();
        dialog.show();
        Objects.requireNonNull(dialog.getWindow()).setBackgroundDrawableResource(android.R.color.transparent);
        bg_layout.setBackgroundResource(Constant.getDrawbles().get(themePosition).drawable);
