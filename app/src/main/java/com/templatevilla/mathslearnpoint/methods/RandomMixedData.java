...
import com.templatevilla.mathslearnpoint.model.MixedModel;
...
public class RandomMixedData {
    ...
    private String space, question_sign, equal_sign, addition_sign, multiplication_sign, division_sign, subtrcation_sign;
    ...
    public RandomMixedData(Context context, String type, boolean isPdf) {
        ...
        subtrcation_sign = context.getString(R.string.subtraction_sign);
...
//            answer = answer - digit_4;
            ...
            question = digit_1 + addition_sign + digit_2 + multiplication_sign + digit_3 + subtrcation_sign + digit_4;


        } else if (randomSign == 2) {

//            answer = digit_1 * digit_2;
//            answer1 = digit_3 + digit_4;
//            answer = answer - answer1;

            answer = digit_1 * digit_2;
            answer = answer - digit_3;
            answer = answer + digit_4;
            question = digit_1 + multiplication_sign + digit_2 + subtrcation_sign + digit_3 + addition_sign + digit_4;
...
//            answer = digit_1 - answer;
            ...
            answer = digit_3 * digit_4;
            int answer1 = digit_1 - digit_2;
            answer = answer1 + answer;
            question = digit_1 + subtrcation_sign + digit_2 + addition_sign + digit_3 + multiplication_sign + digit_4;
...
//        question = (int) digit_2 + "  " + (int) digit_1 + "%-a";
...
//        op_3 = answer - 5;
        ...
        double op_1 = answer1 + 2;
        double op_2 = answer1 + 5;
        double op_3 = answer1 - 5;


        Log.e("answer1", "" + answer1);

        return new MixedModel(question, returnFormatNumber(answer1), returnFormatNumber(op_1), returnFormatNumber(op_2), returnFormatNumber(op_3));
...
//        answer =  String.format(Locale.US, "%.2f", answer1) ;
//        answer = (int) answer1;
...
//        return addMixedModel();
    ...
    public String returnFormatNumber(double answer1) {
    ...
    public MixedModel getCubeRootData() {
        ...
        if (type.equals(context.getString(R.string.easy))) {
            firstDigit = random.nextInt(300) + 2;
        } else if (type.equals(context.getString(R.string.medium))) {
            firstDigit = random.nextInt(2000) + 500;
        } else {
            firstDigit = random.nextInt(4000) + 2000;
...
//        return addMixedModel();
    ...
    private MixedModel getAdditionNumber(String type) {
        ...
        if (isSign) {
            ...
            return new MixedModel(question, addition_sign, multiplication_sign, division_sign, subtrcation_sign);
        } else {
    ...
    private MixedModel getSubtractionNumber(String type) {
        ...
        question = question_sign + subtrcation_sign + space + secondDigit + equal_sign + space + (firstDigit - secondDigit);


        if (isSign) {
            question = firstDigit + question_sign + secondDigit + equal_sign + space + (firstDigit - secondDigit);
            return new MixedModel(question, subtrcation_sign, multiplication_sign, division_sign, addition_sign);
        } else {
            ...
            if (random_number == 1) {
                ...
                question = firstDigit + subtrcation_sign + addition_sign + question_sign + equal_sign + space + (firstDigit - secondDigit);
                answer = secondDigit;
            } else {
                question = firstDigit + subtrcation_sign + addition_sign + space + secondDigit + equal_sign + question_sign;
                answer = (firstDigit - secondDigit);
            }
    ...
    private MixedModel getMultiplicationNumber(String type) {
        ...
        if (isSign) {
            question = firstDigit + question_sign + secondDigit + equal_sign + space + (firstDigit * secondDigit);
            return new MixedModel(question, multiplication_sign, addition_sign, division_sign, subtrcation_sign);
        } else {
    ...
    private MixedModel getDivisionNumber(String type) {
        ...
        if (isSign) {
            question = firstDigit + question_sign + secondDigit + equal_sign + space + (firstDigit / secondDigit);
            return new MixedModel(question, division_sign, addition_sign, multiplication_sign, subtrcation_sign);
        } else {
